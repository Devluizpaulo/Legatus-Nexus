...
export default function SubscriptionPage() {
    ...
    if (!currentUser || !tenantData || (currentUser.role !== 'Master' && currentUser.role !== 'Financeiro')) {
        return (
    ...
    if (!subscription || !plan) {
        return <div>Carregando informações de assinatura...</div>;
    }
    ...
    return (
        <div className="flex flex-col gap-8">
            <div>
                ...
                <p className="text-muted-foreground">Gerencie o plano e o faturamento do seu escritório.</p>
            </div>
