...
const cases: Case[] = [
  ...
  { id: "case-5", tenantId: "tenant-1", title: "Agravo de Instrumento - Stark", caseNumber: '0033445-56.2023.8.26.0100', comarca: 'São Paulo', vara: '10ª Vara Cível', clientId: 'client-1', status: 'Análise Inicial', area: "Cível", responsible: ['user-1'], deadline: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000).toISOString(), summary: "Recurso contra decisão interlocutória.", caseValue: 120000, urgency: "Emergência" },
  { id: "case-6", tenantId: "tenant-1", title: "Acordo Extrajudicial - Wayne", caseNumber: 'NEG-002', clientId: 'client-2', status: 'Contrato Assinado', area: "Cível", responsible: ['user-2'], summary: "Negociação para evitar litígio.", caseValue: 80000, urgency: "Normal" },
  { id: "case-7", tenantId: "tenant-1", title: "Inicial - Danos Morais", caseNumber: 'PEND-003', clientId: 'client-1', status: 'Redação da Inicial', area: "Cível", responsible: ['user-2'], summary: "Ação por negativação indevida.", caseValue: 30000, urgency: "Alta" },
];
