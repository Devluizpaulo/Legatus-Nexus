...
const cases: Case[] = [
  ...
  { id: "case-4", tenantId: "tenant-1", title: "Análise de Contrato Social", caseNumber: '0011223-34.2021.8.26.0100', comarca: 'São Paulo', vara: '1ª Vara Empresarial e de Conflitos de Arbitragem', clientId: "client-2", status: "Proposta Comercial", area: "Empresarial", responsible: ["user-3"], summary: "Revisão de cláusulas de sociedade.", caseValue: 15000, urgency: "Normal" },

  // New Prospect Funnel Examples
  { id: "prospect-1", tenantId: "tenant-1", title: "Novo Lead - Cyberdyne", clientId: "client-3", status: "Lead Inicial", area: "Empresarial", responsible: ["user-1"], summary: "Contato inicial via website para consultoria." },
  { id: "prospect-2", tenantId: "tenant-1", title: "Qualificar - Cyberdyne", clientId: "client-3", status: "Qualificação do Caso", area: "Empresarial", responsible: ["user-1"], summary: "Contato inicial via website para consultoria.", caseValue: 150000, urgency: "Alta" },
  { id: "prospect-3", tenantId: "tenant-1", title: "Triagem - Cyberdyne", clientId: "client-3", status: "Triagem Jurídica", area: "Empresarial", responsible: ["user-1"], summary: "Contato inicial via website para consultoria.", caseValue: 150000, urgency: "Alta", triageAnalysis: "O caso parece ter alta viabilidade, mas precisamos coletar a troca de e-mails com o consumidor e o contrato de prestação de serviços.", viability: "Alta", requirements: [{ id: "req-1", text: "Troca de e-mails com consumidor", completed: false }, { id: "req-2", text: "Contrato de prestação de serviços", completed: false }] },
  { id: "prospect-4", tenantId: "tenant-1", title: "Reunião - Cyberdyne", clientId: "client-3", status: "Reunião com Cliente", area: "Empresarial", responsible: ["user-1"], summary: "Contato inicial via website para consultoria.", caseValue: 150000, urgency: "Alta", triageAnalysis: "Análise preliminar positiva.", viability: "Alta", requirements: [] },
  { id: "prospect-5", tenantId: "tenant-1", title: "Proposta - Cyberdyne", clientId: "client-3", status: "Proposta Comercial", area: "Empresarial", responsible: ["user-1"], summary: "Contato inicial via website para consultoria.", caseValue: 150000, urgency: "Alta", triageAnalysis: "Análise preliminar positiva.", viability: "Alta", requirements: [] },
  { id: "prospect-6", tenantId: "tenant-1", title: "Contrato - Cyberdyne", clientId: "client-3", status: "Contrato Assinado", area: "Empresarial", responsible: ["user-1"], summary: "Contato inicial via website para consultoria.", caseValue: 150000, urgency: "Alta", triageAnalysis: "Análise preliminar positiva.", viability: "Alta", requirements: [] },
  { id: "prospect-7", tenantId: "tenant-1", title: "Documentos - Cyberdyne", clientId: "client-3", status: "Coleta de Documentos", area: "Empresarial", responsible: ["user-1"], summary: "Contato inicial via website para consultoria.", caseValue: 150000, urgency: "Alta", triageAnalysis: "Análise preliminar positiva.", viability: "Alta", requirements: [{ id: 'doc-1', text: 'Procuração Ad-Judicia', completed: true }, { id: 'doc-2', text: 'Contrato Social', completed: true }, { id: 'doc-3', text: 'Comprovante de Inscrição', completed: false }] },
